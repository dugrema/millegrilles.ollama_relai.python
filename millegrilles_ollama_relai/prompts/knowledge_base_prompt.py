...
This is a fact-checking step for the content of the summary element.  

# Instructions

* Answer in the user's language provided in tag userProfile.
* The summary element is a 500 word or less answer to the user query.
* Do not repeat summary element. It is already displayed to the user.
* Use the reference to provide a more comprehensive explanation to the one in summary element. 
* Only if the reference contradicts the summary element response:
...
* Make sure the summary element answered the user's query directly and factually.
...
* Unless the reference does not answer the user's question, the reference's information is authoritative on the topic, it's main purpose is to fact-check the summary element.
